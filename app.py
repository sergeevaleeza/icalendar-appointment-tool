            ...
            if rrule:
                ...
                try:
                    ...
                    for occurrence in rule.between(start_of_year, end_of_year, inc=True):
                        ...
                        if is_target_day(local_occ, days) and is_in_target_months(local_occ, months, year):
                            appointments.append({
                                'title': summary,
                ...
                if is_target_day(local_dt, days) and is_in_target_months(local_dt, months, year):
                    appointments.append({
                        'title': summary,
